		...
		<table border="2">
			...
			<tr>
				<td colspan="2" align="middle">
					<input type="button" value="작성완료" onclick="document.getElementById('fundingform').submit()">
					<input type="button" value="다시작성" onclick="document.getElementById('fundingform').reset()">
